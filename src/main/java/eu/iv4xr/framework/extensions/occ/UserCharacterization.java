...
/**
 * This class models a user, or a type of users, in terms of how they appraise incoming events
 * towards e.g. goals that matter for them. 
 */
public abstract class UserCharacterization {
	
	
	/**
	 * This method should model the semantic of an Event in terms of an update 
	...
	/* Commenting this out. These are not really goal-oriented appraisal...
	public abstract int praiseWorthinessAppraisalRule(... String eventName ...)
	
	public abstract int desirabilityTowardsOtherAppraisalRule(... String eventName ...) 
