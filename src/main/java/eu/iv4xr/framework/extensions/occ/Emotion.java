...
public class Emotion {
	 ...
	 */
	public enum EmotionType { Joy, Distress, Hope, Fear, Disappointment, Satisfaction }
	
	
	/**
	 * Just a constant array holding all possible emotion types, so that we can quantify
	 * over it.
     */ 
    public static EmotionType[] emotionTypes = {
        EmotionType.Joy,
    ...
    //static List<EmotionType> exclusionAxiom1 = Arrays.asList(EmotionType.Joy, EmotionType.Distress) ;
    //staticList<EmotionType> exclusionAxiom2 = Arrays.asList(EmotionType.Hope, EmotionType.Fear) ;
    //static List<EmotionType> exclusionAxiom3 = Arrays.asList(EmotionType.Satisfaction, EmotionType.Disappointment);
    //static List<EmotionType> exclusionAxiom4 = Arrays.asList(EmotionType.Joy, EmotionType.Hope, EmotionType.Satisfaction);
    //staticList<EmotionType> exclusionAxiom5 = Arrays.asList(EmotionType.Distress, EmotionType.Fear, EmotionType.Disappointment);
     ...
     * That is, if one is present, the other should not.
     */ 
    public static boolean exclusion(EmotionType ety1, EmotionType ety2)
    {
        if (ety1 == ety2) return false;
